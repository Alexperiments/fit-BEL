...
def parser():
    ...
    parser.add_argument('-o', '--output', type=str, help='optional output folder', default='outputs/')
    parser.add_argument('-p', '--plot', type=str, help='optional output plot folder', default='figures/')
    return parser
